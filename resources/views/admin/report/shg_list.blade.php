...
<section class="content-header">
    <div class="container-fluid">
        ...
        <div class="card card-info"> 
            <div class="card-body"> 
                <form action="{{ route('admin.report.shglist.generate') }}"method="post" class="add_form" success-content-id="result_table" data-table-without-pagination="result_datatable" no-reset="true">
                    {{ csrf_field() }} 
                    <div class="row"> 
