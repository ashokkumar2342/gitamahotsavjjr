      ...
      <div class="card-body"> 
        <div class="row"> 
          ...
          <div class="col-lg-4 form-group">
              ...
              <input type="text" name="bank_name" class="form-control" placeholder="Enter Bank Name" maxlength="50">
          </div>
          <div class="col-lg-4 form-group">
          ...
          <div class="col-lg-4 form-group">
              ...
              <input type="date" name="account_opening_date" class="form-control">
          </div>
          <div class="col-lg-4 form-group">
              ...
              <select name="degignation" id="degignation" class="form-control">
                ...
                @foreach ($Degignations as $Degignation)       
                  <option value="{{$Degignation->id}}">{{$Degignation->desig_name}}</option>
                @endforeach
              </select>
          </div> 
          <div class="col-lg-4 form-group">
