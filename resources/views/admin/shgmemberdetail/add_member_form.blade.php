<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{ route('admin.shg.detail.selfhelpgroup.store.member',Crypt::encrypt($selfHelpGroupId)) }}" method="post" class="add_form" button-click="btn_close" select-triger="shg_select_box">
                {{ csrf_field() }}
                <div class="row"> 
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <select name="marital_status" id="marital_status" class="form-control">
                            ...
                            <option value="2">Marrried</option>
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <input type="text" name="age" class="form-control" maxlength="3" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                    </div>
                    <div class="col-lg-4 form-group">
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <input type="text" name="ppp" class="form-control" placeholder="Enter PPP ID" maxlength="20">
                    </div>
                    <div class="col-lg-4 form-group">
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <input type="text" name="pincode" class="form-control" maxlength="6" minlength="6" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                    </div>
                    <div class="col-lg-4 form-group">
                        <label for="exampleInputPassword1">Account No.</label>
                        <input type="text" name="account_no" class="form-control" placeholder="Enter Account No." maxlength="20" minlength="9" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                    </div>
                    <div class="col-lg-4 form-group">
                        <label for="exampleInputPassword1">Bank Branch Name</label>
                        <input type="text" name="bank_branch_name" class="form-control" placeholder="Enter Bank Branch Name" maxlength="50">
                    </div>
                    <div class="col-lg-4 form-group">
                        <label for="exampleInputPassword1">Ifsc Code</label>
                        <input type="text" name="ifsc_code" class="form-control" placeholder="Enter Ifsc Code" maxlength="20">
                    </div>             
                    <div class="col-lg-4 form-group">
                        ...
                        <select name="education_qualification" class="form-control">
                            ...
                            <option value="2">Under Primary</option>
                            <option value="3">Under High</option>
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <select name="income" class="form-control">
                            ...
                            <option value="3">10000 - 150000</option>
                            <option value="4">More than 150000</option>
                        </select>
                    </div>
                    <div class="col-lg-4 form-group">
                    ...
                    <div class="col-lg-4 form-group">
                        ...
                        <input type="text" name="ayushman" class="form-control">
                    </div>              
